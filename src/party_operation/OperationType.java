...
public enum OperationType {
    RANDOM_SELECT(0, "てきとう", "何も考えない"), 
    RECOVERY_FIAST(1, "いのちだいじに", "回復を優先する"),
    REDUCE_LOW_HP_ENEMY(2, "てきをへらす", "HPの低い敵を優先して倒す"), 
    REDUCE_LOW_DEF_ENEMY(3, "たくさんだめーじ", "防御力の低い敵を優先して攻撃する"),
    ...
    public String getOpetationManual() {
